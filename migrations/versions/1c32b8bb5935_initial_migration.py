...
Revision ID: 1c32b8bb5935
Revises: 
Create Date: 2025-06-03 18:37:06.441164
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['outfit_template_id'], ['outfit_template.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('current_rod_id', sa.Integer(), nullable=True),
    sa.Column('current_bait_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['current_bait_id'], ['item.id'], ),
    sa.ForeignKeyConstraint(['current_rod_id'], ['item.id'], ),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('current_bait_id'),
    sa.UniqueConstraint('current_rod_id'),
    ...
    sa.Column('description', sa.String(), nullable=False),
    sa.Column('status', sa.Enum('Pending', 'Reviewed', 'Rejected', 'Penalty', name='recordstatus'), nullable=False),
    sa.Column('created_date', sa.DateTime(), nullable=True),
